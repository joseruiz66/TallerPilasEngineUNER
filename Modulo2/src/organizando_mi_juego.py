...
En base al juego disparar monos del Practico N° 1 vamos a agregarle música y un menú de presentación con
tres opciones “jugar”, “ayuda” y “salir”. Esto nos permitirá aprender nuevas técnicas, empezando por la
modularización y la organización del juego en torno a escenas.
...
class EscenaJuego(pilasengine.escenas.Escena):
    ...
    def crear_personajes(self):
        ...
        self.torreta = self.pilas.actores.Torreta(municion_bala_simple=self.municion_bala_simple,
    ...
    def crear_enemigo(self):
        ...
        self.pilas.utils.interpolar(enemigo, 'escala', 0.5, duracion=0.5, tipo='elastico')
        ...
        self.pilas.utils.interpolar(enemigo, 'x', 0, duracion=self.tiempo, tipo=interpolacion)
        self.pilas.utils.interpolar(enemigo, 'y', 0, duracion=self.tiempo, tipo=interpolacion)
